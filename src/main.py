    ...
    try:
        ...
        while True:
            ...
            if choice == "0":
                ...
                try:
                    recommendations = engine.get_product_recommendations(ean, k=k, filters=filters)
                ...
                recommendations = engine.get_recommendations_by_text(query, k=k, filters=filters)
